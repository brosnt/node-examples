...
session.match().then(
  function() {
	  ...
	  console.log("p2 Amount=["+ p1.amount +"], HeldForReview=["+ p2.holdForManualReview +"], Rejected=["+ p2.rejected +"]");
	  console.log("p3 Amount=["+ p1.amount +"], HeldForReview=["+ p3.holdForManualReview +"], Rejected=["+ p3.rejected +"]");
	  console.log("p4 Amount=["+ p1.amount +"], HeldForReview=["+ p4.holdForManualReview +"], Rejected=["+ p4.rejected +"]");
